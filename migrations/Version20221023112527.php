 ...
 */
final class Version20221023112527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE circonscription (id INT AUTO_INCREMENT NOT NULL, details_circonscription_id INT NOT NULL, region VARCHAR(255) NOT NULL, departement VARCHAR(255) NOT NULL, arrondissement VARCHAR(255) NOT NULL, commune VARCHAR(255) NOT NULL, bureau INT NOT NULL, UNIQUE INDEX UNIQ_FEDDA65A6C113FA2 (details_circonscription_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
